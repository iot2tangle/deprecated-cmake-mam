...
retcode_t trit_t_to_mam_msg_read_context_t_map_init(trit_t_to_mam_msg_read_context_t_map_t *const map, size_t const key_size,
...
size_t trit_t_to_mam_msg_read_context_t_map_size(trit_t_to_mam_msg_read_context_t_map_t const map) {
...
retcode_t trit_t_to_mam_msg_read_context_t_map_add(trit_t_to_mam_msg_read_context_t_map_t *const map,
                                              trit_t const *const key, mam_msg_read_context_t const *const value) {
  trit_t_to_mam_msg_read_context_t_map_entry_t *map_entry = NULL;
  map_entry = (trit_t_to_mam_msg_read_context_t_map_entry_t *)malloc(sizeof(trit_t_to_mam_msg_read_context_t_map_entry_t));
...
bool trit_t_to_mam_msg_read_context_t_map_contains(trit_t_to_mam_msg_read_context_t_map_t const map,
...
bool trit_t_to_mam_msg_read_context_t_map_find(trit_t_to_mam_msg_read_context_t_map_t const map, trit_t const *const key,
                                          trit_t_to_mam_msg_read_context_t_map_entry_t **res) {
  if (map.map == NULL) {
    return false;
  }
...
bool trit_t_to_mam_msg_read_context_t_map_cmp(trit_t_to_mam_msg_read_context_t_map_t const lhs,
                                         trit_t_to_mam_msg_read_context_t_map_t const rhs) {
