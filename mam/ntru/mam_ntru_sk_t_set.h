...
typedef retcode_t (*mam_ntru_sk_t_on_container_func)(void *container, mam_ntru_sk_t * type);
...
bool mam_ntru_sk_t_set_find(mam_ntru_sk_t_set_t const set, mam_ntru_sk_t const *const, mam_ntru_sk_t_set_entry_t **entry);
