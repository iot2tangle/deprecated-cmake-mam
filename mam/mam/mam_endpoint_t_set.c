...
size_t mam_endpoint_t_set_size(mam_endpoint_t_set_t const set) { return HASH_COUNT(set); }

retcode_t mam_endpoint_t_set_add(mam_endpoint_t_set_t *const set, mam_endpoint_t const *const value) {
...
retcode_t mam_endpoint_t_set_remove(mam_endpoint_t_set_t *const set, mam_endpoint_t const *const value) {
  mam_endpoint_t_set_entry_t *entry = NULL;
...
retcode_t mam_endpoint_t_set_remove_entry(mam_endpoint_t_set_t *const set, mam_endpoint_t_set_entry_t *const entry) {
...
retcode_t mam_endpoint_t_set_append(mam_endpoint_t_set_t const *const set1, mam_endpoint_t_set_t *const set2) {
  retcode_t ret = RC_OK;
...
bool mam_endpoint_t_set_contains(mam_endpoint_t_set_t const set, mam_endpoint_t const *const value) {
  mam_endpoint_t_set_entry_t *entry = NULL;
...
bool mam_endpoint_t_set_find(mam_endpoint_t_set_t const set, mam_endpoint_t const *const value, mam_endpoint_t_set_entry_t **entry) {
  if (set == NULL) {
    return false;
  }
...
retcode_t mam_endpoint_t_set_for_each(mam_endpoint_t_set_t const set, mam_endpoint_t_on_container_func func, void *const container) {
  retcode_t ret = RC_OK;
...
bool mam_endpoint_t_set_cmp(mam_endpoint_t_set_t const lhs, mam_endpoint_t_set_t const rhs) {
