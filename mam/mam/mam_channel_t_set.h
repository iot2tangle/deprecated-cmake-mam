...
#ifndef __UTILS_CONTAINERS_SET_mam_channel_t_SET_H__
#define __UTILS_CONTAINERS_SET_mam_channel_t_SET_H__
...
typedef struct mam_channel_t_set_entry_s {
  mam_channel_t value;
  UT_hash_handle hh;
}
mam_channel_t_set_entry_t;

typedef mam_channel_t_set_entry_t *mam_channel_t_set_t;

typedef retcode_t (*mam_channel_t_on_container_func)(void *container, mam_channel_t * type);

size_t mam_channel_t_set_size(mam_channel_t_set_t const set);
...
bool mam_channel_t_set_find(mam_channel_t_set_t const set, mam_channel_t const *const, mam_channel_t_set_entry_t **entry);
...
#endif  // __UTILS_CONTAINERS_SET_mam_channel_t_SET_H__
